...
function validateForm() {
	...
	if (essayWords > 1500) {
		alert(
			`Opps, you've exceeded with ${essayCount} word(s). Make sure your essay is exactly "1500" words`
		);
		return false;
	}
	if (essayWords < 1500) {
		alert(
			`Opps, you've ${essayCount} word(s) less than the target. Make sure your essay is exactly "1500" words`
		);
		return false;
	}
}
